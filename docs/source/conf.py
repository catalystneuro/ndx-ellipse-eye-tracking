...
# -*- coding: utf-8 -*-
#
# ndx-ellipse-eye-tracking documentation build configuration file, created by
# sphinx-quickstart on Wed Jan 27 13:30:32 2021.
#
...
project = 'ndx-ellipse-eye-tracking'
...
htmlhelp_basename = 'ndx-ellipse-eye-trackingdoc'
...
latex_documents = [
    (master_doc, 'ndx-ellipse-eye-tracking.tex', 'ndx-ellipse-eye-tracking Documentation',
     'Ben Dichter', 'manual'),
]
...
man_pages = [
    (master_doc, 'ndx-ellipse-eye-tracking', 'ndx-ellipse-eye-tracking Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ndx-ellipse-eye-tracking', 'ndx-ellipse-eye-tracking Documentation',
     author, 'ndx-ellipse-eye-tracking', 'One line description of project.',
     'Miscellaneous'),
]
