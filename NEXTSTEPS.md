...
# Next Steps for ndx-ellipse-eye-tracking Extension for NWB

## Creating Your Extension

1. In a terminal, change directory into the new ndx-ellipse-eye-tracking directory.
...
`spec/ndx-ellipse-eye-tracking.namespace.yaml` and
`spec/ndx-ellipse-eye-tracking.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-ellipse-eye-tracking
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/bendichter/ndx-ellipse-eye-tracking/releases/tag/0.1.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).

9. Publish your updated extension on [PyPI](https://pypi.org/).
    - Follow these directions: https://packaging.python.org/tutorials/packaging-projects/
    - You may need to modify `setup.py`
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-ellipse-eye-tracking/0.1.0
...
`staged-extensions/ndx-ellipse-eye-tracking`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-ellipse-eye-tracking
    ```

13. Edit `staged-extensions/ndx-ellipse-eye-tracking/ndx-meta.yaml`
...
version: 0.1.0
src: https://github.com/bendichter/ndx-ellipse-eye-tracking
pip: https://pypi.org/project/ndx-ellipse-eye-tracking/
license: BSD 3-Clause
maintainers: 
  - bendichter
```

14. Edit `staged-extensions/ndx-ellipse-eye-tracking/README.md`
to add information about your extension. You may copy it from
`ndx-ellipse-eye-tracking/README.md`.

```bash
cp ndx-ellipse-eye-tracking/README.md staged-extensions/ndx-ellipse-eye-tracking/README.md
```

15. Add and commit your changes to Git and push your changes to GitHub.
```
cd staged-extensions
git add ndx-ellipse-eye-tracking
git commit -m "Add new catalog entry for ndx-ellipse-eye-tracking" .
git push
```
...
ndx-ellipse-eye-tracking-feedstock will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-ellipse-eye-tracking GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-ellipse-eye-tracking-feedstock repository on GitHub.
